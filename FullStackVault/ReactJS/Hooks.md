...
## [](https://pt-br.reactjs.org/docs/hooks-intro.html#motivation)Motivação
...
### [](https://pt-br.reactjs.org/docs/hooks-intro.html#its-hard-to-reuse-stateful-logic-between-components)É Difícil Reutilizar Lógica com Estado entre Componentes
...
### [](https://pt-br.reactjs.org/docs/hooks-intro.html#complex-components-become-hard-to-understand)Componentes Complexos se Tornam Difíceis de Entender
...
### [](https://pt-br.reactjs.org/docs/hooks-intro.html#classes-confuse-both-people-and-machines)Classes Confundem tanto Pessoas quanto Máquinas
...
## [](https://pt-br.reactjs.org/docs/hooks-intro.html#gradual-adoption-strategy)Estratégia Gradual de Adoção
...
## [](https://pt-br.reactjs.org/docs/hooks-intro.html#frequently-asked-questions)
